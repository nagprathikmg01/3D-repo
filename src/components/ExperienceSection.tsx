  ...
  const experiences = [
    {
      ...
      description: "Designed and trained ML models focused on carbon emissions optimization, implementing data ingestion pipelines and deploying analytics dash.",
    },
    {
      ...
      description: "Representing Google Developer student community. Organizing and facilitating developer workshops, hackathons, and GCP bootcamps.",
    },
    {
      role: "Marketing Head",
      company: "IEEE Computer Society Chapter – NMIT",
    ...
    },
    {
      ...
      company: "Team Adwaitha | DataWiz | CloudZilla",
      duration: "Dec 2024 – Present",
      icon: Compass,
      color: "from-orange-500 to-amber-500",
      glow: "rgba(249,115,22,0.15)",
      description: "Directing PR operations, speaker engagement, and logistics for hackathons and inter-collegiate technical symposia, hosting 200+ participants.",
    },
  ];
